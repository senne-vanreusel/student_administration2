    ...
    <div class="row">
        <div class="col-sm-6 mb-2">
            <input type="text" class="form-control" name="course" id="course"
                   value="{{request()->course}}" placeholder="Filter Course Name Or Description">
        </div>
...
@if($courses->count()==0)
    <div class="alert alert-danger alert-dismissible fade show">
        Can't find any course <b>'{{ request()->course }}'</b>
        @if(request()->programme_id  != '%')
            in the programme <b>{{$order[request()->programme_id-1]->name}}</b>
        @endif
